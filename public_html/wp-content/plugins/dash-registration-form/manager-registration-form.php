...
/*
  Plugin Name: Manager registration form
	For team managers
  Tracy Dash
 */


class Manager_registration_form
{
    ...
    function __construct()
    {
        ...
        add_shortcode('manager_registration_form', array($this, 'shortcode'));
	...
	// creating array to add using wp_insert_user
	    ...
	    add_user_meta( $register_user, 'team_role', manager);
