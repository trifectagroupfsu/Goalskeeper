...
function display_extra_login_info(){
	...
	echo '<p>New here? Register as a <a href="http://youthcoaching.x10host.com/player-registration">player, </a><a href="http://youthcoaching.x10host.com/parent-registration">parent, </a>or <a href="http://youthcoaching.x10host.com/coach-registration">coach.</a><a href="http://youthcoaching.x10host.com/recover-password"><br/ >Need to recover your password?<br/ ></a></p>';
    }
}
...
function login_if_user_is_not_logged_in (){
    if ( !is_user_logged_in () ) {
        auth_redirect ();
    }
}

// shortcode: [login-if-user-is-not-logged-in]
add_shortcode ( 'login-if-user-is-not-logged-in' , 'login_if_user_is_not_logged_in' );
