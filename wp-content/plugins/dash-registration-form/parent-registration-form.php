...
/*
  Plugin Name: Parent Registration Form
  Tracy Dash
 */
...
class Parent_registration_form
{
    ...
    function __construct()
    {
        ...
        add_shortcode('parent_registration_form', array($this, 'shortcode'));
	...
	// creating array to add using wp_insert_user
	    ...
	    add_user_meta( $register_user, 'team_role', parent);
	    add_user_meta( $register_user, 'parent_phone', $this->phone);
	    add_user_meta( $register_user, 'parent_street_address', $this->street_address);
	    add_user_meta( $register_user, 'parent_city', $this->city);
	    add_user_meta( $register_user, 'parent_state', $this->state);
