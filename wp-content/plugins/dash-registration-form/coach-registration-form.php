...
class Coach_registration_form
{
	...
	// creating array to add using wp_insert_user
	    ...
	    add_user_meta( $register_user, 'coach_phone', $this->phone);
	    add_user_meta( $register_user, 'coach_address', $this->street_address);
	    add_user_meta( $register_user, 'coach_city', $this->city);
	    add_user_meta( $register_user, 'coach_state', $this->state);
